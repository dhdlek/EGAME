  ...
  <head>
    ...
    <script>
      ...
      function product_print(productList) {
        ...
        if (productList.length != 0) {
          for (const t of productList) {
            var count = 0;
            var productStatus;
            if(t.productStatus == "Y")
            {
            	productStatus = "판매 중";
            }
            else if(t.productStatus == "N")
           	{
            	productStatus = "승인 대기중"; 	
           	}
            else if(t.productStatus == "S")
           	{
            	productStatus = "정지된 상품";
           	}
      ...
      function search_reset() {
        ...
        $("select[name='product_status'] option:eq(0)").prop("selected", true);
        $(".current").html(" ");
      }
